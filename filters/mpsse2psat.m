function check = mpsse2psat(filename)
...
if ~isa(filename,'char')
    error('OOPSAT:INPUTCHK','Input must be char array.')
end
check = 0;
...
try
  gencost = mpc.gencost;
    ...
    warning('OOPSAT:CONVERSION','Missing gencost field.')
end
