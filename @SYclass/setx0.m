...
psat_obj.DAE.y(a.p) = a.u.*psat_obj.Bus.Pg(a.bus).*a.con(:,22);
psat_obj.DAE.y(a.q) = a.u.*psat_obj.Bus.Qg(a.bus).*a.con(:,23);
a.Pg0 = psat_obj.DAE.y(a.p);
Vg = psat_obj.DAE.y(a.vbus);
ag = psat_obj.DAE.y(a.bus);
V =  Vg.*exp(psat_obj.jay*ag);
S = psat_obj.DAE.y(a.p) - psat_obj.jay*psat_obj.DAE.y(a.q);
I = S./conj(V);
delta = angle(V + (ra + psat_obj.jay*xq).*I);
psat_obj.DAE.x(a.delta) = a.u.*delta;

% d and q-axis voltages and currents
Vdq = a.u.*V.*exp(-psat_obj.jay*(delta-pi/2));
Idq = a.u.*I.*exp(-psat_obj.jay*(delta-pi/2));
vd = real(Vdq);
vq = imag(Vdq);
a.Id = real(Idq);
a.Iq = imag(Idq);
...
if ~isempty(is3)
  ...
  a.c2(is3) = xd1(is3).*K;
  a.c3(is3) = xq(is3).*K;
  psat_obj.DAE.x(a.e1q(is3)) = vq(is3)+ra(is3).*a.Iq(is3)+xd1(is3).*a.Id(is3);
  a.vf0(is3) = synsat(a,1,psat_obj.DAE.x(a.e1q(is3)),is3)+(xd(is3)-xd1(is3)).*a.Id(is3);
end
if ~isempty(is4)
  ...
  a.c2(is4) = xd1(is4).*K;
  a.c3(is4) = xq1(is4).*K;
  psat_obj.DAE.x(a.e1q(is4)) = vq(is4)+ra(is4).*a.Iq(is4)+xd1(is4).*a.Id(is4);
  psat_obj.DAE.x(a.e1d(is4)) = vd(is4)+ra(is4).*a.Id(is4)-xq1(is4).*a.Iq(is4);
  a.vf0(is4) = synsat(a,1,psat_obj.DAE.x(a.e1q(is4)),is4)+ ...
...
if ~isempty(is51)
  ...
  psat_obj.DAE.x(a.e1q(is51)) = vq(is51)+ra(is51).*a.Iq(is51)+xd1(is51).*a.Id(is51);
  psat_obj.DAE.x(a.e2d(is51)) = vd(is51)+ra(is51).*a.Id(is51)-xd1(is51).*a.Iq(is51);
  psat_obj.DAE.x(a.e1d(is51)) = (xq(is51)-xq1(is51)- ...
                          Tq20(is51).*xd1(is51).* ...
                          (xq(is51)-xq1(is51))./Tq10(is51)./ ...
                          xq1(is51)).*a.Iq(is51);
  a.vf0(is51) = synsat(a,1,psat_obj.DAE.x(a.e1q(is51)),is51)+ ...
...
if ~isempty(is52)
  ...
  psat_obj.DAE.x(a.e2q(is52)) = vq(is52)+ra(is52).*a.Iq(is52)+xd2(is52).*a.Id(is52);
  psat_obj.DAE.x(a.e2d(is52)) = vd(is52)+ra(is52).*a.Id(is52)-xq2(is52).*a.Iq(is52);
  k1 = xd(is52)-xd1(is52)-Td20(is52).*xd2(is52).* ...
       (xd(is52)-xd1(is52))./Td10(is52)./xd1(is52);
  k2 = xd1(is52)-xd2(is52)+Td20(is52).*xd2(is52).* ...
       (xd(is52)-xd1(is52))./Td10(is52)./xd1(is52);
  %a.vf0(is52) = (k1+k2).*a.Id(is52)+psat_obj.DAE.x(a.e2q(is52));
  psat_obj.DAE.x(a.e1q(is52)) = -k1.*Taa(is52)./Td10(is52).* ...
      a.Id(is52)+(1-Taa(is52)./Td10(is52)).* ...
      (psat_obj.DAE.x(a.e2q(is52)) + k2.*a.Id(is52));
  a.vf0(is52) = (k1.*a.Id(is52)+synsat(a,1,psat_obj.DAE.x(a.e1q(is52)),is52))./ ...
      (1-Taa(is52)./Td10(is52));
end
if ~isempty(is53)
  psat_obj.DAE.x(a.psid(is53)) = ra(is53).*a.Iq(is53) + vq(is53);
  psat_obj.DAE.x(a.psiq(is53)) = -(ra(is53).*a.Id(is53) + vd(is53));
  psat_obj.DAE.x(a.e1q(is53)) = psat_obj.DAE.x(a.psid(is53)) + xd(is53).*a.Id(is53);
  a.vf0(is53) = psat_obj.DAE.x(a.e1q(is53));
end
if ~isempty(is6)
  ...
  a.c2(is6) = xd2(is6).*K;
  a.c3(is6) = xq2(is6).*K;
  psat_obj.DAE.x(a.e2q(is6)) = vq(is6)+ra(is6).*a.Iq(is6)+xd2(is6).*a.Id(is6);
  psat_obj.DAE.x(a.e2d(is6)) = vd(is6)+ra(is6).*a.Id(is6)-xq2(is6).*a.Iq(is6);
  psat_obj.DAE.x(a.e1d(is6)) = (xq(is6)-xq1(is6)-Tq20(is6).* ...
  ...
  k2 = xd1(is6)-xd2(is6)+Td20(is6).*xd2(is6).* ...
       (xd(is6)-xd1(is6))./Td10(is6)./xd1(is6);
  %a.vf0(is6) = (k1+k2).*a.Id(is6)+psat_obj.DAE.x(a.e2q(is6));
  psat_obj.DAE.x(a.e1q(is6)) = psat_obj.DAE.x(a.e2q(is6))+k2.*a.Id(is6)- ...
      Taa(is6)./Td10(is6).*((k1+k2).*a.Id(is6)+psat_obj.DAE.x(a.e2q(is6)));
  a.vf0(is6) = (k1.*a.Id(is6)+synsat(a,1,psat_obj.DAE.x(a.e1q(is6)),is6))./ ...
      (1-Taa(is6)./Td10(is6));
end
if ~isempty(is8)
  psat_obj.DAE.x(a.psid(is8)) =  ra(is8).*a.Iq(is8) + vq(is8);
  psat_obj.DAE.x(a.psiq(is8)) = -ra(is8).*a.Id(is8) - vd(is8);

  psat_obj.DAE.x(a.e2d(is8)) = -psat_obj.DAE.x(a.psiq(is8)) - xq2(is8).*a.Iq(is8);
  psat_obj.DAE.x(a.e2q(is8)) =  psat_obj.DAE.x(a.psid(is8)) + xd2(is8).*a.Id(is8);
  
  psat_obj.DAE.x(a.e1d(is8)) = (xq(is8)-xq1(is8)-Tq20(is8).* ...
  ...
  %a.vf0(is8) = (k1+k2).*a.Id(is8)+psat_obj.DAE.x(a.e2q(is8));
  
  psat_obj.DAE.x(a.e1q(is8)) = -k1.*Taa(is8)./Td10(is8).* ...
      a.Id(is8)+(1-Taa(is8)./Td10(is8)).* ...
      (psat_obj.DAE.x(a.e2q(is8)) + k2.*a.Id(is8));
  
  a.vf0(is8) = (k1.*a.Id(is8)+synsat(a,1,psat_obj.DAE.x(a.e1q(is8)),is8))./ ...
      (1-Taa(is8)./Td10(is8));

end

psat_obj.DAE.y(a.pm) = a.u.*a.pm0;
psat_obj.DAE.y(a.vf) = a.u.*a.vf0;

% find & delete static generators
for j = 1:a.n
  if ~fm_rmgen(a.bus(j)*a.u(i),psat_obj)
      check = 0;
  end
end

psat_obj.fm_disp('Initialization of Synchronous Machines completed.')
