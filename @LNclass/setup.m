...
a.p = getzeros(psat_obj.Bus);
a.q = getzeros(psat_obj.Bus);
...
if ~isempty(idx)
  ...
  a.con(idx,9)  = a.con(idx,6).*a.con(idx,9)./XB*(2*pi*psat_obj.Settings.freq);
  a.con(idx,10) = a.con(idx,6).*a.con(idx,10).*XB*(2*pi*psat_obj.Settings.freq);
