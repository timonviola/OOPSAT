function varargout = flows(a,psat_obj,varargin)
...
z = r + i*x;
y = a.u(idx)./z;
Vf = psat_obj.DAE.y(a.vfr(idx)).*exp(i*psat_obj.DAE.y(a.fr(idx)));
Vt = psat_obj.DAE.y(a.vto(idx)).*exp(i*psat_obj.DAE.y(a.to(idx)));  
