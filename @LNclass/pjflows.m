function F = pjflows(a,type,pfl,flag,psat_obj)
...
% line flows
V1 = psat_obj.DAE.y(a.vfr(pfl));
V2 = psat_obj.DAE.y(a.vto(pfl));
theta1 = psat_obj.DAE.y(a.fr(pfl));
theta2 = psat_obj.DAE.y(a.to(pfl));
rl = a.con(pfl,8);
xl = a.con(pfl,9);
