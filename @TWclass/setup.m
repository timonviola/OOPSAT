...
switch nargin-1
 case 3
  ...
  psat_obj.Line = varargin{2};
 otherwise
  %global psat_obj.Bus psat_obj.Line
end
...
data(:,[5 6]) = psat_obj.Bus.con(psat_obj.Bus.int(a.con(:,2)),[5 6]);
[psat_obj.Bus,twt_bus] = add(psat_obj.Bus,data,'',a.con(:,1),'(twt)');
...
if nargin == 3
  psat_obj.Line = add(psat_obj.Line,[line1; line2; line3],psat_obj.Bus);
else
  psat_obj.Line = add(psat_obj.Line,[line1; line2; line3]);
end
