...
if isempty(a.con)
  a.store = [];
  psat_obj.fm_disp('Error: No slack bus found.',2)
...
b = unique(a.bus);
if a.n > length(b)
  psat_obj.fm_disp(['Error: More than one slack generator ', ...
...
psat_obj.DAE.y(a.vbus) = a.con(:,4);
if ~sum(psat_obj.DAE.y(Bus.a)) && a.n == 1
  psat_obj.DAE.y(Bus.a) = a.con(1,5);
else
  psat_obj.DAE.y(a.bus) = a.con(:,5);
end
